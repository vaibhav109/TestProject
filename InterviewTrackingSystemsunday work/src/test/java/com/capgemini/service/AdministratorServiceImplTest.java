...
class AdministratorServiceImplTest {
	...
	void testFindScheduleInterviewShouldReturnInterviewSchedule() throws NoSuchInterviewScheduleException {
		...
		expected.setInterviewId(3);
		expected.setFinalStatus("ok");
		expected.setTechRating("6");
		expected.setInterviewDate("12/10/2020");
		expected.setInterviewTime("1pm");
		expected.setHrRating("5");
		expected.setDeleteStatus(false);
	...
	void testModifyTechRatingShouldReturnInterviewId() {
		InterviewSchedule interviewSchedule = new InterviewSchedule(3, "rate", "rate", "pending", "19/06/2021", "1pm",
				false);

		int result = administratorService.updateInterviewScheduleOfTechRatig(3, "5");
		interviewSchedule = administratorService.viewInterviewById(3);
	...
	void testModifyHrRatingShouldReturnInterviewId() {
		...
		int result = administratorService.updateInterviewScheduleOfHrRating(3, "6");
		interviewSchedule = administratorService.viewInterviewById(3);
	...
	void testModifyFinalStatusShouldReturnInterviewId() {
		InterviewSchedule interviewSchedule = new InterviewSchedule(3, "rate", "rate", "pending", "19/06/2021", "1pm",
				false);
		interviewSchedule = administratorService.viewInterviewById(3);
		int result = administratorService.updateInterviewScheduleOfFinalStatus(3, "ok");
		assertEquals("ok", interviewSchedule.getFinalStatus());
	}

	/*
	 * @Test void testCancelInterviewShouldReturnInterviewId() { InterviewSchedule
	 * interviewSchedule = new InterviewSchedule(1, "5", "6", "ok", "12/10/2020",
	 * "1pm", false); boolean result = administratorService.cancelInterview(1,
	 * true); interviewSchedule = administratorService.viewInterviewById(1);
	...
	/*
	 * @Test void testsearchEmployeeByIdShouldReturnEmployee() throws
	 * EmployeeByIdNotFoundException { Employee expected =
	 * context.getBean(Employee.class); expected.setEmployeeId(1);
	 * expected.setEmployeeName("Test"); expected.setDepartment("Test");
	...
	/*
	 * @Test public void testShouldNoSuchPanelIdException() { //PanelMember expected
	 * = context.getBean(PanelMember.class); NoSuchPanelIdException exception =
	 * assertThrows(NoSuchPanelIdException.class, () -> {
	 * administratorService.viewPanelMemberById(1); });
	 * 
	 * }
	 */
