...
public interface TechPanelService
{
	...
	public int updateCandidateTechRating(int interviewId, String techRating) throws NoSuchInterviewIdException; // update
																												// candidate
																												// techRating
	...
	public List<PanelMember> viewPanelMemberByType(String employeeType) throws NoSuchPanelTypeFound; // view panel
																										// members by
																										// typ
}
