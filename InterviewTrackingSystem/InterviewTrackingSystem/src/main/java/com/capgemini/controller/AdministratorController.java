...
public class AdministratorController {
	...
	// http://localhost:9090/project-api/admin/login
	...
	//http://localhost:9090/project-api/admin/resgistration
	...
	public ResponseEntity<String> saveCandidate(@RequestBody Candidate candidate) {
		...
		if (result) {
			response = new ResponseEntity<String>("Candidate with id " + candidate.getCandidateId() + " is created.",
					HttpStatus.CREATED);
		}
		return response;
	}
	...
	public ResponseEntity<String> saveinterviewSchedule(@RequestBody InterviewSchedule interviewSchedule) {
		...
		if (result) {
			response = new ResponseEntity<String>(
					" Interview with  " + interviewSchedule.getInterviewId() + " is schedule.", HttpStatus.CREATED);
			try {
	...
	// http://localhost:9090/project-api/admin/updateInterviewScheduleOfTechRatig/1/4
	// - PUT
	@PutMapping(path = "updateInterviewScheduleOfTechRatig/{interviewId}/{techRating}")
	public ResponseEntity<String> updateInterviewScheduleOfTechRatig(
			@PathVariable(value = "techRating") String techRating,
	...
	// http://localhost:9090/project-api/admin/updateInterviewScheduleOfHrRating/1/4
	// - PUT
	...
	// http://localhost:9090/project-api/admin/updateInterviewScheduleOfFinalStatus/1/Ok
	// - PUT
	@PutMapping(path = "updateInterviewScheduleOfFinalStatus/{interviewId}/{finalStatus}")
	public ResponseEntity<String> updateInterviewScheduleOfFinalStatus(
			@PathVariable(value = "finalStatus") String finalStatus,
			@PathVariable(value = "interviewId") int interviewId) {
		ResponseEntity<String> response = null;
		InterviewSchedule interviewSchedule = null;
	...
	public ResponseEntity<String> deactivateInterviewSchedule(@RequestBody @PathVariable("interviewId") int interviewID,
			@PathVariable("deleteStatus") boolean deleteStatus) {
		ResponseEntity<String> response = null;
		boolean result = service.cancelInterview(interviewID, deleteStatus);
		if (result) {
			response = new ResponseEntity<String>("Interview Schedule with id " + interviewID + " is deleted.",
					HttpStatus.OK);
		}
		return response;
	}
	...
	public ResponseEntity<String> savePanelMember(@RequestBody PanelMember panelMember) {
		...
		if (result) {
			response = new ResponseEntity<String>("PanelMember with id " + panelMember.getPanelId() + " is created.",
					HttpStatus.CREATED);
		}
		return response;
	}
	...
	public ResponseEntity<String> saveEmployee(@RequestBody Employee employee) {
		...
		if (result) {
			response = new ResponseEntity<String>(
					"Employee with Employee Id " + employee.getEmployeeId() + " is created.", HttpStatus.CREATED);
		}
		return response;
	}
