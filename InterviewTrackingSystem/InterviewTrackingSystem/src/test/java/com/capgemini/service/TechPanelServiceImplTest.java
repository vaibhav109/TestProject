...
@SpringBootTest
class TechPanelServiceImplTest {
...
//	//test case for updating techrating by interviewId
//	@Test
//	void testModifyTechRatingShouldReturnInterviewId()
//	{
//		InterviewSchedule interviewSchedule= new InterviewSchedule(1,"5","6","ok","12/5/2021","1pm",false);
//		interviewSchedule = administratorService.viewInterviewById(1);
//		int result = administratorService.updateInterviewScheduleOfTechRatig(1,"selected");
//		assertEquals(interviewSchedule.getTechRating(),"selected");
//	}
	...
	public void testShouldReturnAllCandidates() throws CandidateNotFoundException {
		...
		list.add(expected);
		int count = list.size();
		List<Candidate> actual = tservice.viewInterviewMemebers();
	...
	public void testShouldReturnAllPanelMemberByType() throws NoSuchPanelTypeFound {
		...
		list.add(expected);
		int count = list.size();
		List<PanelMember> actual = tservice.viewPanelMemberByType(expected.getEmployeeType());
		assertEquals(count, actual.size());
	}
	...
	void testModifyTechRatingShouldReturnInterviewId() {
		...
		int result = administratorService.updateInterviewScheduleOfTechRatig(4, "selected");
	...
	public void testShouldThrowCandidateNotFoundException() {
		...
		CandidateNotFoundException exception = assertThrows(CandidateNotFoundException.class, () -> {
			tservice.viewCandidateById(111);
		});
	}
	...
	public void testShouldThrowNoSuchPanelIdException() {
		...
		NoSuchPanelIdException exception = assertThrows(NoSuchPanelIdException.class, () -> {
			tservice.viewPanelMemberById(110);
		});
	}
